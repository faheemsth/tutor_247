            ...
            <div class="col-md-10 col-12 align-items-baseline">
                <div class="row border border-muted rounded-1 border-1">
                    <div class="col-xl-7 col-md-6 col-12 py-3">
                        ...
                        <input style="width: 80%;" class="border-0 search-bar-filter" type="text"
                            ...
                            <div class="card-body">
                                ...
                                <div class="range my-2">
                                    ...
                                    <div class="range-input">
                                        <input type="number" placeholder="Min Price " class="form form-control mx-1 "
                                            id="outline-remove">
                                        <input type="number" placeholder="Max Price" class="form form-control  "
                                            id="outline-remove">
                                    </div>
                                ...
                                <div class="location my-2">
                                    ...
                                    <div class="location-content mx-3">
                                        <input type="text" class="form-control" id="outline-remove"
                                            style=" height: 50px; " placeholder="Enter zipcode ">
                       ...
                       @foreach ($tutors as $tutor)
                        <div class="row py-3">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="{{ $tutor->image }}" alt="" class="img-fluid">
                                    </div>
                                    <div class="col-md-9 justify-content-lg-start mt-4 mt-md-0">
                                            ...
                                            <div class="col-md-8 ">
                                                <div class="d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <img src="./assets/images/Verified-p.png" class="correctiocn mx-1"
                                                            alt="">
                                                    </div>
                                        ...
                                        <div class="d-flex py-ld-3">
                                            <button class="custom-button">
                                                <img class="button-img mx-2 d-none d-md-inline-block"
                                                    src="./assets/images/Icon2.png" alt="Button Image">Student's home
                                            </button>
                                            <button class="custom-button mx-2">
                                                <img class="button-img mx-2 d-none d-md-inline-block"
                                                    src="./assets/images/Icon3.png" alt="Button Image">Online
                                            </button>
                                        </div>
                                        <div class="row align-items-center mt-2">
                                            ...
                                            <div
                                                ...
                                                <a href="" class="btn button1 text-center border-1"><b>Let’s
                                                        chat</b></a>
                                                <a href="{{ url('tutor_profile').'/'.$tutor->id }}" class="btn button2 mx-1 "><b>View full
                                                        profile</b></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9 justify-content-lg-start mt-4 mt-md-0">
                                        ...
                                        <div class="row align-items-center mt-2">
                                            ...
                                            <div
                                                ...
                                                <a href="" class="btn button1 text-center border-1"><b>Let’s
                                                        chat</b></a>
                                                <a href="./profile.html" class="btn button2 mx-1 "><b>View full
                                                        profile</b></a>
                                            </div>
                                        </div>
                                    </div>
