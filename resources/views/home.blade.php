        ...
        <div class="d-flex justify-content-between my-5">
            <div>
                <a href="https://themicly.com/products/radmin/">
                    <img height="30" src="{{ asset('img/24_7_logo.png') }}">
                </a>
            </div>
            <div>
        ...
        <div class="row justify-content-center">
            <div class="my-5">
                ...
                <div class="card-body template-demo text-center">
                    <a href="https://themicly.com" class="btn social-btn text-white btn-google"><i
                            class="ik ik-globe"></i></a>
                    <a href="https://github.com/themicly" class="btn social-btn text-white btn-facebook "><i
                            class="fab fa-github"></i></a>
                    <a href="https://twitter.com/themiclyBd" class="btn social-btn text-white btn-twitter"><i
                            class="fab fa-twitter"></i></a>
                    <a href="https://www.linkedin.com/in/rakibhstu/" class="btn social-btn text-white btn-linkedin"><i
